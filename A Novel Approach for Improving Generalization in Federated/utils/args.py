...
def get_parser():
    ...
    parser.add_argument('--data_portion', type=str, default="", help='portion of data used. 100 means all.')
    parser.add_argument('--l2r', type = float, default=0.01, help = "coefficient of the L2 regulizer" )
    parser.add_argument('--cmi', type = float, default=0.001, help = "coefficient of the mutual info regulizer")
    return parser
